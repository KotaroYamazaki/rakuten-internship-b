  ...
  <div class="ui fixed inverted menu">
        ...
        <div class="ui column centered grid">
            ...
            <div class="ten wide column">
                <h1 class="ui header">{{ $project_name }}</h1>
                <div class="ui divider"></div>
                    <div class="ui horizontal list">
                        <?php foreach($project_members as $project_member): ?>
                        <div class="item">
                            <img class="ui avatar image" src="/projects/{{ $project_member }}" alt='image'>
                            <div class="content">
                ...
                <div class="ui message">
                    <div class="content">
                        <div class="header"><h3>Why don't we join Hackthon? @9/14</h3></div>
                        ...
                        Many people also have their own barometers for what makes a cute dog.</p>
                        </div>
                    </div>
                </div>
        </div> 
